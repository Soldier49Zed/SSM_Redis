...
import com.houx.service.RedisRedPacketService;
    ...
    public void saveUserRedPacketByRedis(Long redPacketId, Double unitAmount) {
        ...
        for (int i = 0; i < times; i++) {
            ...
            for (int j = 0; j < userIdList.size(); j++) {
                ...
                userRedPacket.setGradTime(new Timestamp(time));
        ...
        System.err.println("保存数据结束，共耗时: " + (end - start) + "毫秒，共:" + count + "条记录被保存");
    }
